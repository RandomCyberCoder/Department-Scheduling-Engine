...
public class Other {
    ...
    public static Timetable generateDemoData(TimetableApp.DemoData demoData) {
        ...
        if (demoData == TimetableApp.DemoData.LARGE) {
    ...
    private static void printTimetable(Timetable timeTable) {
        ...
        Other.LOGGER.info("|            | " + rooms.stream()
                .map(room -> String.format("%-10s", room.getName())).collect(Collectors.joining(" | ")) + " |");
        Other.LOGGER.info("|" + "------------|".repeat(rooms.size() + 1));
        for (Timeslot timeslot : timeTable.getTimeslots()) {
            ...
            Other.LOGGER.info("| " + String.format("%-10s",
        ...
        if (!unassignedLessons.isEmpty()) {
            Other.LOGGER.info("");
            Other.LOGGER.info("Unassigned lessons");
            for (Lesson lesson : unassignedLessons) {
                Other.LOGGER.info("  " + lesson.getSubject() + " - " + lesson.getTeacher() + " - " + lesson.getStudentGroup());
            }
        }
    }
}
