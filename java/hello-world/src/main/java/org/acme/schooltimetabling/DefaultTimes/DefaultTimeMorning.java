...
public class DefaultTimeMorning implements DefaultTime {
    private static final DefaultTimeMorning INSTANCE;
    private BitSet conflict;
    private BitSet acceptable;
    private BitSet preference;

    static {
        INSTANCE = new DefaultTimeMorning();
    ...
    private DefaultTimeMorning() {}

    public static DefaultTimeMorning getInstance() {
        return INSTANCE;
    }
