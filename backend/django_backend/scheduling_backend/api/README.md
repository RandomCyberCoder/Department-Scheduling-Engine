...
done curl -X PATCH http://localhost:8000/api/teachers/update/bulk/ -H "Content-Type: application/json" -d '[{"lookup": {"id": 5}, "update_data": {"csc": "True"}}, {"lookup": {"non_canon_name": "bad", "canon_name": "Migler, Andrew Carl"}, "update_data": {"csc": "True"}}]'